...
function showMoveAnimation(row1:number, column1:number, row2:number, column2:number) {
...
function hasNoBlockHorizontally(row:number, column1:number, column2:number) {
...
function hasNoBlockVertically(column:number, row1:number, row2:number) {
...
function updateBoardView() {
    ...
    $(".number-cell").css("line-height", cellSideLength + "px")
        .css("font-size", 0.45 * cellSideLength + "px");
}
...
function getPosTop(i:number) {
    return cellSpace + i * (cellSpace + cellSideLength);
}

function getPosLeft(j:number) {
    return cellSpace + j * (cellSpace + cellSideLength);
}

function getNumberBackgroundColor(num:number) {
    switch (num) {
        case 2:
            return "#EEE4DA";
            break;
...
function showNumberWithAnimation(x:number, y:number, num:number) {
...
function getNumberCell(x:number, y:number) {
    return $("#" + getNumberCellId(x, y));
}

function getNumberCellId(x:number, y:number) {
